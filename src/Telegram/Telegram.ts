...
// Copyright (C) 2021 Spelsinx <https://github.com/spelsinx>
//
...
export class Telegram {
  /** @hidden */
  private _TelestaticClient!: Client.Telestatic;
  constructor(TelestaticClient: Client.Telestatic) {
  ...
  async getEntity(chatId: bigint | string | number, useCache?: boolean) {
    return Users.GetEntity(this.TelestaticClient, chatId, useCache);
  }
  // getMe
  async getMe() {
  ...
  async sendMessage(
    ...
    return Messages.sendMessage(this.TelestaticClient, chatId, text, more);
  }
  // deleteMessages
  /**
  ...
  async deleteMessages(chatId: bigint | number | string, messageId: number[]) {
    return Messages.DeleteMessages(this.TelestaticClient, chatId, messageId);
  }
  /**
  ...
  async editMessage(
    ...
    return Messages.EditMessage(this.TelestaticClient, chatId, messageId, text, more);
  }
  // forwardMessages
  /**
  ...
  async forwardMessages(
    ...
    return Messages.ForwardMessages(this.TelestaticClient, chatId, fromChatId, messageId, more);
  }
  /**
  ...
  async getMessages(
    ...
    return Messages.GetMessages(this.TelestaticClient, chatId, messageId, replies);
  }
  // getMessagesViews
  /**
  ...
  async getMessagesViews(
    ...
    return Messages.GetMessagesViews(this.TelestaticClient, chatId, messageId, increment);
  }
  // getUserPhotos
  /**
  ...
  async getUserPhotos(chatId: bigint | number | string, more?: Users.getUserPhotosMoreParams) {
    return Users.GetUserPhotos(this.TelestaticClient, chatId, more);
  }
  // readHistory
  /**
  ...
  async readHistory(chatId: bigint | number | string, more?: Messages.readHistoryMoreParams) {
    return Messages.ReadHistory(this.TelestaticClient, chatId, more);
  }
  // readMentions
  /**
  ...
  async readMentions(chatId: bigint | number | string) {
    return Messages.ReadMentions(this.TelestaticClient, chatId);
  }
  // readMessageContents
  /**
  ...
  async readMessageContents(messageId: number[]) {
    return Messages.ReadMessageContents(this.TelestaticClient, messageId);
  }
  // unpinAllMessages
  /**
  ...
  async unpinAllMessages(chatId: bigint | number | string) {
    return Messages.UnpinAllMessages(this.TelestaticClient, chatId);
  }
  // pinMessages
  /**
  ...
  async pinMessage(
    ...
    return Messages.PinMessage(this.TelestaticClient, chatId, messageId, more);
  }
  // unpinMessages
  /**
   * unpin a message.
  ...
  async unpinMessage(chatId: bigint | number | string, messageId: number) {
    return Messages.PinMessage(this.TelestaticClient, chatId, messageId, { unpin: true });
  }
  // deleteHistory
  /**
  ...
  async deleteHistory(chatId: bigint | number | string, more?: Messages.deleteHistoryMoreParams) {
    return Messages.DeleteHistory(this.TelestaticClient, chatId, more);
  }
  //deleteUserHistory
  /**
  ...
  async deleteUserHistory(chatId: bigint | number | string, userId: number | string) {
    return Messages.DeleteUserHistory(this.TelestaticClient, chatId, userId);
  }
  // editAdmin
  /**
  ...
  async editAdmin(
    ...
    return Chats.EditAdmin(this.TelestaticClient, chatId, userId, more);
  }
  // editBanned
  /**
  ...
  async editBanned(
    ...
    return Chats.EditBanned(this.TelestaticClient, chatId, userId, more);
  }
  // editPhoto
  /**
  ...
  async editPhoto(chatId: bigint | number | string, photo: string | Buffer) {
    return Media.EditPhoto(this.TelestaticClient, chatId, photo);
  }
  /**
  ...
  async editTitle(chatId: bigint | number | string, title: string) {
    return Chats.EditTitle(this.TelestaticClient, chatId, title);
  }
  // exportMessageLink
  /**
  ...
  async exportMessageLink(
    ...
    return Messages.ExportMessageLink(this.TelestaticClient, chatId, messageId, more);
  }
  ...
  async getAdminedPublicChannels(byLocation: boolean = true, checkLimit: boolean = true) {
    return Chats.GetAdminedPublicChannels(this.TelestaticClient, byLocation, checkLimit);
  }
  // getAdminLog
  /**
  ...
  async getAdminLog(chatId: bigint | number | string, more?: Chats.getAdminLogMoreParams) {
    return Chats.GetAdminLog(this.TelestaticClient, chatId, more);
  }
  // getChannels
  /**
  ...
  async getChannels(chatId: bigint[] | number[] | string[]) {
    return Chats.GetChannels(this.TelestaticClient, chatId);
  }
  // getFullChat
  /**
  ...
  async getFullChat(chatId: bigint | number | string) {
    return Chats.GetFullChat(this.TelestaticClient, chatId);
  }
  ...
  async getGroupsForDiscussion() {
    return Chats.GetGroupsForDiscussion(this.TelestaticClient);
  }
  // getInactiveChannels
  /**
  ...
  async getInactiveChannels() {
    return Chats.GetInactiveChannels(this.TelestaticClient);
  }
  // getLeftChannels
  /**
  ...
  async getLeftChannels(offset: number = 0) {
    return Chats.GetLeftChannels(this.TelestaticClient, offset);
  }
  // sendMedia
  /**
  ...
  async sendMedia(
    ...
    return Media.SendMedia(this.TelestaticClient, chatId, media, more);
  }
  // sendPhoto
  /**
  ...
  async sendPhoto(
    ...
    return Media.SendPhoto(this.TelestaticClient, chatId, fileId, more);
  }
  // sendDocument
  /**
   ...
   *     let results = await ctx.telegram.sendDocument(ctx.chat.id,"https://telestatic.js.org/images/telestatic.jpg")
   * })
   * ```
   */
  async sendDocument(
    ...
    return Media.SendDocument(this.TelestaticClient, chatId, fileId, more);
  }
  // sendSticker
  /**
  ...
  async sendSticker(
    ...
    return Media.SendSticker(this.TelestaticClient, chatId, fileId);
  }
  // sendVideo
  /**
   * Sending Video
  ...
  async sendVideo(
    ...
    return Media.SendVideo(this.TelestaticClient, chatId, fileId, more);
  }
  // sendVideoNote
  /**
  ...
  async sendVideoNote(
    ...
    return Media.SendVideoNote(this.TelestaticClient, chatId, fileId, more);
  }
  // sendAnimation
  /**
   * Sending Animation
  ...
  async sendAnimation(
    ...
    return Media.SendAnimation(this.TelestaticClient, chatId, fileId, more);
  }
  // sendAudio
  /**
   * Sending Audio
  ...
  async sendAudio(
    ...
    return Media.SendAudio(this.TelestaticClient, chatId, fileId, more);
  }
  // sendVoice
  /**
   * Sending Voice
  ...
  async sendVoice(
    ...
    return Media.SendVoice(this.TelestaticClient, chatId, fileId, more);
  }
  // sendDice
  async sendDice(
    chatId: bigint | number | string,
    ...
    return Media.SendDice(this.telestaticClient, chatId, dice, more);
  }
  // sendContact
  /**
   * Sending Contact
  ...
  async sendContact(
    ...
    return Media.SendContact(this.TelestaticClient, chatId, contact, more);
  }
  // sendPoll
  /**
   * Sending Polling
  ...
  async sendPoll(
    ...
    return Media.SendPoll(this.TelestaticClient, chatId, poll, more);
  }
  // sendLocation
  /**
   * Sending Location
  ...
  async sendLocation(
    ...
    return Media.SendLocation(this.TelestaticClient, chatId, location, more);
  }
  // sendVenue
  /**
   * Sending Venue
  ...
  async sendVenue(
    ...
    return Media.SendVenue(this.TelestaticClient, chatId, venue, more);
  }
  // getParticipant
  /**
  ...
  async getParticipant(chatId: bigint | string | number, userId: string | number) {
    return Chats.GetParticipant(this.TelestaticClient, chatId, userId);
  }
  // getChatMember
  /**
   * Get info about a channel/supergroup participant.
  ...
  async getChatMembersCount(chatId: bigint | number | string) {
    return Chats.GetChatMembersCount(this.TelestaticClient, chatId);
  }
  // getParticipants
  /**
  ...
  async getParticipants(chatId: bigint | number | string, more?: Chats.GetParticipantMoreParams) {
    return Chats.GetParticipants(this.TelestaticClient, chatId, more);
  }
  // getChatMembers
  /**
   * Getting list from all participants in channel or chats.
  ...
  async answerInlineQuery(
    ...
    return Bots.AnswerInlineQuery(this.TelestaticClient, queryId, results, more);
  }
  ...
  async banChatMember(chatId: bigint | number | string, userId: bigint | number | string) {
    return Chats.EditBanned(this.TelestaticClient, chatId, userId);
  }
  async kickChatMember(chatId: bigint | number | string, userId: bigint | number | string) {
    await Chats.EditBanned(this.TelestaticClient, chatId, userId);
    return Chats.EditBanned(this.TelestaticClient, chatId, userId, {
      untilDate: 0,
      viewMessages: false,
      sendMessages: false,
  ...
  async download(
    ...
    return Media.Download(this.telestaticClient, media, params);
  }
  /**
  ...
  async sendInvoice(
    ...
    return Media.SendInvoice(this.telestaticClient, chatId, invoice, more);
  }
  async answerPrecheckoutQuery(id: bigint, ok: boolean, error?: string) {
    return Bots.AnswerPrecheckoutQuery(this.telestaticClient, id, ok, error);
  }
  async answerShippingQuery(id: bigint, options?: Array<Bots.ShippingOptions>, error?: string) {
    return Bots.AnswerShippingQuery(this.telestaticClient, id, options, error);
  }
}
