...
export interface InterfaceTelestaticSession {
  authKey: any;
  dcId: number;
  port: number;
...
export class TelestaticSession extends MemorySession {
  /** @hidden */
  private _sessionName!: string;
  /** @hidden */
  private client!: Telestatic;
  constructor(sessionName: string, client: Telestatic) {
    super();
